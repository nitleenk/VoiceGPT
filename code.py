...
TELEGRAM_API_TOKEN="<YOUR API KEY>"

messages=[{"role":"system","content":"you are a helpful telegram bot"}]
...
def voice_message(update,context):
    update.message.reply_text("I have received a voice message. Please give me a second to respond")
